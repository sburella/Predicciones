...
#GRAFICO GANANCIAS APROXIMADAS Y INDICADOR DE TALLA CAMARON   
  # Espacio entre los gráficos
            ...
            dbc.Row([
                ...
                ], width=6, id='pie-chart-container'),
...
def grafico_predicciones(date, n_clicks_multiple, n_clicks_simple, n_clicks_polinomica):
    ...
    pie_chart = px.pie(values=df_unique['Comentario'].value_counts().values, names=df_unique['Comentario'].value_counts().index, hole=.5, title='Tipo de Balanceado')
    ...
    return date, fig_peso, fig_costo, pie_chart, bar_chart, 'Precisión: ' + r2_display
